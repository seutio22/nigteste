/*
  ...
  - Added the required column `nome` to the `Demanda` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Cliente" ADD COLUMN "grupoEconomico" TEXT;

-- AlterTable
ALTER TABLE "Contrato" ADD COLUMN "codigo" TEXT;
ALTER TABLE "Contrato" ADD COLUMN "grupoEconomico" TEXT;

-- RedefineTables
PRAGMA defer_foreign_keys=ON;
PRAGMA foreign_keys=OFF;
CREATE TABLE "new_Analista" (
...
INSERT INTO "new_Analista" ("areaId", "createdAt", "email", "id", "nome", "telefone", "updatedAt") SELECT "areaId", "createdAt", "email", "id", "nome", "telefone", "updatedAt" FROM "Analista";
DROP TABLE "Analista";
ALTER TABLE "new_Analista" RENAME TO "Analista";
