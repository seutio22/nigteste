// Script para testar o novo endpoint /create-new-user
const https = require('https');

async function testCreateNewUser() {
  console.log('🧪 TESTANDO NOVO ENDPOINT /create-new-user');
  console.log('==========================================');
...
async function createNewUser() {
  try {
    ...
    const result = await makeRequest('/create-new-user', 'POST', newUserData);
...
testCreateNewUser().catch(console.error);
