# Fontes – Geometria (Design System)

Coloque aqui os arquivos da família **Geometria** para que o sistema use a tipografia do MDS.
...
- **Extra Bold:** 800, line-height 125%  

Se os arquivos não estiverem nesta pasta, o navegador usará a fonte genérica `sans-serif`.
