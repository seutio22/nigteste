          ...
          <Grid item xs={12} sm={6} md={4}>
            <Controller name="estruturaEdge" control={control} render={({ field }) => (
              ...
              >
                ...
                <MenuItem value="7">7-ERRO Plano; Cadastrado/Coberturas</MenuItem>
                <MenuItem value="8">8-ERRO Financeiro</MenuItem>
                <MenuItem value="9">9-ERRO Limite Técnico</MenuItem>
                <MenuItem value="10">10-ERRO Coparticipação</MenuItem>
                <MenuItem value="11">11-ERRO Contribuição</MenuItem>
                <MenuItem value="12">12-ERRO Dados Gerais</MenuItem>
              </TextField>
            )} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
